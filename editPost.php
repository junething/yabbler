    ...
    <body>
        ...
        <table width="100%" class="backgroundTable" bgcolor="#ffffff" style="margin-top: 100px;">
             <tr>
                 <td>
                    <?php
						$spaceTitle=str_replace("+", " ", $row['postTitle']);
						$postBody=$row['postBody'];
					?>
					<form action=\"submitEditedPost.php\" method=\"post\"> <input type=\"hidden\" name=\"oldPostTitle\"value=\"$spaceTitle\">
					<input name=\"newPostTitle\"type=\"text\" value=\"$spaceTitle\" placeholder=\"title\"><br>
					<textarea name=\"newPostBody\"rows=\"30\" cols=\"100\"placeholder=\"title\"><?$postBody</textarea><br>
					<button type="submit"><i class="fa fa-pencil-square-o"></i>Update</button></form>
					?>
